...
x_train_standardized, x_test_standardized = standardize_data(
    x_train_stripped, x_test_stripped
)

w, loss = mean_absolute_error_gd(
    y_train, x_train_standardized, np.zeros(x_train_standardized.shape[1]), 500, 0.01
)
